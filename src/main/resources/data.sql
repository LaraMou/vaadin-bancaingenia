...
insert into movimiento(id,concepto,descripcion,fecha,fecha_valor,importe,id_categoria,id_cuenta,id_tarjeta)
values (2,'Pago escuela','Pago escuela','2021-01-12','2021-01-12',-2000,4,1,444441);

insert into movimiento(id,concepto,descripcion,fecha,fecha_valor,importe,id_categoria,id_cuenta,id_tarjeta)
values (3,'Pago restaurante italiano','Pago en restaurante italiano','2021-02-12','2021-02-12',-25,4,1,444441);
...
insert into movimiento(id,concepto,descripcion,fecha,fecha_valor,importe,id_categoria,id_cuenta,id_tarjeta)
values (9,'Retirada de efectivo','retirada de efectivo','2021-08-12','2021-08-12',3000,4,1,444441);
